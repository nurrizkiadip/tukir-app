        ...
        <div class='faq_wrapper'>
          <ul class='items'>
            <li>
              ...
              <ul class='sub-items'>
                <li>
                  ...
                  <p>sebelumnya pernah ada cabang, hanya saja sulitnya mendapatkan orang yang bisa dipercaya untuk mengelolanya..</p>
                </li>
              </ul>
            </li>
            <li>
            ...
            <li>
              ...
              <ul class='sub-items'>
                <li>
                  <p class="half_space">Tergantung dari harga bahan - bahan pasaran, sebisa mungkin kami mencari harga terbaik dengan kualitas terbaik.</p>
            ...
            <li>
              ...
              <ul class='sub-items'>
                <li>
                  <p>sudah citarasa khas langsung dari Madiun bahwa sambel pecelnya kaya akan rasa pedas yang khas.</p>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul class='sub-items'>
                <li>
                  <p>Mengambil tempat yang strategis dan juga rindang agar terasa sejuk saat terkena paparan matahari.</p>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul class='sub-items'>
                <li>
                  <p>untuk saat ini masih bekerjasama dengan mitra seperti gojek dan shopee agar bisa membantu sesama dan memanfaatkan teknologi sebaik mungkin.</p>
                </li>
              </ul>
            </li>
          </ul>
